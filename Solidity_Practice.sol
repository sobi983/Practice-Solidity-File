...
//Dynamic array in structure along with the mapping
// contract sobi{
//    struct student{
//        uint[] age;
//    }
   
//    mapping(address=>student)   q;

//    function set(uint a) public{
//       q[msg.sender].age.push(a);
//    }

//    function getValue(address a) public view returns(student memory ){
//       return q[a];
//    }
// }
